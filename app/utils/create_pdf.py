...
def vlute_xuat_danh_gia(
    input_pdf_path: str, output_pdf_path: str, data: dict, username: str
):
...
def ctu_chinh_phieu_tiep_nhan(
    input_pdf_path: str, output_pdf_path: str, data: str, username: str
):
    print(data)
    reader = PdfReader(input_pdf_path)
    writer = PdfWriter()
