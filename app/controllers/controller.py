...
def get_all_tham_so_controller(uid: int):
...
def them_tham_so_controller(ten: str, thamso: str, giatri: str, mota: str, hethong: int, trangthai: int, uid: int):
    return them_tham_so(ten, thamso, giatri, mota, hethong, trangthai, uid)


def cap_nhat_tham_so_controller(id: int, ten: str, thamso: str, giatri: str, mota: str, trangthai: int, uid: int):
    return cap_nhat_tham_so(id, ten, thamso, giatri, mota, trangthai, uid)
